...
```
    ...
    Plotted profile 1 to:
     ...
     results/escape_profiles/Linfa-NUS_antibodies_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_1.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/Linfa-NUS_antibodies_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Linfa-NUS_antibodies_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/Linfa-NUS_antibodies_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Linfa-NUS_antibodies_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_5.png)
    ...
    Plotted profile 4 to:
     results/escape_profiles/Linfa-NUS_antibodies_set1_stackedlogo.pdf
     results/escape_profiles/Linfa-NUS_antibodies_set1_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_7.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/Linfa-NUS_antibodies_set1_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Linfa-NUS_antibodies_set1_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_9.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/Linfa-NUS_antibodies_set1_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Linfa-NUS_antibodies_set1_color_by_expr_stackedlogo.png.
